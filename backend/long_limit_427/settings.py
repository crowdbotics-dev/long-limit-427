"""
Django settings for long_limit_427 project.
...
ROOT_URLCONF = 'long_limit_427.urls'
...
WSGI_APPLICATION = 'long_limit_427.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "long_limit_427 API",
    "DESCRIPTION": "API documentation for long_limit_427 App",
    "VERSION": "v1",
}
